...
class BeginToken extends SimpleToken {
  ...
  BeginToken(TokenType type, int offset, [CommentToken? precedingComment])
    ...
    assert(type == TokenType.LT ||
        ...
        type == TokenType.OPEN_DOUBLE_SQUARE_BRACKET ||
...
class Keyword extends TokenType {
  ...
  static const Keyword INTERFACE = const Keyword(
      "interface", "INTERFACE", KeywordStyle.builtIn,
      isTopLevelKeyword: true);
  ...
  // slice begin
  static const Keyword MODULE = Keyword(
      'module', 'MODULE', KeywordStyle.reserved,
      isTopLevelKeyword: true);
  static const Keyword EXCEPTION = Keyword(
      'exception', 'EXCEPTION', KeywordStyle.reserved,
      isTopLevelKeyword: true);
  static const Keyword STRUCT =
      Keyword('struct', 'STRUCT', KeywordStyle.reserved);
  static const Keyword SEQUENCE =
      Keyword('sequence', 'SEQUENCE', KeywordStyle.reserved);
  static const Keyword DICTIONARY =
      Keyword('dictionary', 'DICTIONARY', KeywordStyle.reserved);
  static const Keyword OPTIIONAL =
      Keyword('optional', 'OPTIIONAL', KeywordStyle.reserved);
  static const Keyword THROWS =
      Keyword('throws', 'THROWS', KeywordStyle.reserved);
  static const Keyword OBJECT =
      Keyword('Object', 'OBJECT', KeywordStyle.reserved);
  static const Keyword LOCALOBJECT =
      Keyword('LocalObject', 'LOCALOBJECT', KeywordStyle.reserved);
  static const Keyword LOCAL = Keyword('local', 'LOCAL', KeywordStyle.reserved);
  static const Keyword IDEMPOTENT =
      Keyword('idempotent', 'IDEMPOTENT', KeywordStyle.reserved);
  static const Keyword ENDIF = Keyword('endif', 'ENDIF', KeywordStyle.reserved);
  static const Keyword IFDEF = Keyword('ifdef', 'IFDEF', KeywordStyle.reserved);
  static const Keyword IFNDEF =
      Keyword('ifndef', 'IFNDEF', KeywordStyle.reserved);
  static const Keyword INCLUDE =
      Keyword('include', 'INCLUDE', KeywordStyle.reserved);
  static const Keyword DEFINE =
      Keyword('define', 'DEFINE', KeywordStyle.reserved);
  static const Keyword PRAGMA =
      Keyword('pragma', 'PRAGMA', KeywordStyle.reserved);
  static const Keyword DEFINED =
      Keyword('defined', 'defined', KeywordStyle.reserved);
  // slice end
...
class TokenType {
  ...
  // slice begin
  static const TokenType DOUBLE_COLON = const TokenType(
      '::', 'DOUBLE_COLON', PREFIX_PRECEDENCE, DOUBLE_COLON_TOKEN);
  static const TokenType OPEN_DOUBLE_SQUARE_BRACKET = const TokenType(
      '[[',
      'OPEN_DOUBLE_SQUARE_BRACKET',
      SELECTOR_PRECEDENCE,
      OPEN_DOUBLE_SQUARE_BRACKET_TOKEN);
  static const TokenType CLOSE_DOUBLE_SQUARE_BRACKET = const TokenType(
      ']]',
      'CLOSE_DOUBLE_SQUARE_BRACKET',
      NO_PRECEDENCE,
      CLOSE_DOUBLE_SQUARE_BRACKET_TOKEN);
  ...
  static const List<TokenType> all = const <TokenType>[
    ...
    TokenType.OPEN_DOUBLE_SQUARE_BRACKET,
    TokenType.CLOSE_DOUBLE_SQUARE_BRACKET,
