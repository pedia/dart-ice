...
abstract class ObjectAdapter {
  ...
  /// @see #findDefaultServant
  ///
  // ObjectPrx removeDefaultServant(String category);
  ...
  /// @see #findByProxy
  ///
  // ObjectPrx findFacet(Identity id, String facet);
  ...
  /// @see #findFacet
  ///
  // ObjectPrx findByProxy(Object proxy);
  ...
  /// @see #removeDefaultServant
  ///
  // ObjectPrx findDefaultServant(String category);
