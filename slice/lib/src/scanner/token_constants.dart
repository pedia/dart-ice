...
//
const int DOUBLE_COLON_TOKEN = QUESTION_PERIOD_PERIOD_TOKEN + 1;
const int OPEN_DOUBLE_SQUARE_BRACKET_TOKEN = QUESTION_PERIOD_PERIOD_TOKEN + 2;
const int CLOSE_DOUBLE_SQUARE_BRACKET_TOKEN = QUESTION_PERIOD_PERIOD_TOKEN + 3;
